  ...
  render() {
    return (
      <div>
        ...
        <MapContainer style={{ height: "80vh", width: "40vw", display: "inline-block" }} zoom={9.5} center={[10.75, 106.7]} minZoom={5} maxZoom={15} zoomSnap={0.5}>
          <GeoJSON
        ...
        <MapContainer style={{ height: "80vh", width: "40vw", display: "inline-block" }} zoom={9.5} center={[21.00, 105.6]} minZoom={5} maxZoom={15} zoomSnap={0.5}>
          <GeoJSON
            style={this.wardStyle}
